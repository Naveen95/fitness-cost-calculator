                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class = 'row'>
                            ...
                            <form action = "trainingplanscost.php" method = "POST">

                        <div class =form-group>

                                  <label for = 'Name'>Select Package</label>
                                    <select class='form-control' name='training_package'>
                                        <option value='wlt'>Weight Loss </option>
                                        <option value='s'>Strengthening</option>
